...
(function() {
    ...
    var q = {},
        ...
        r, t, la, ma, u, na, oa, pa, v, qa, ra, sa, x, y, z, B, C, D, ta, E, G, ua, va, wa, xa, ya, za, H, Aa, Ba, Ca, Da, I, Fa, Ga, Ha, Ia, J, K, KB, L, M, N, Ja = document.createElement("img"),
        Ka, La, Ma, Na, Oa, Pa, Qa, Ra, Sa, Ta, Ua, O, Va, P, Q, R, S, Wa, T, Xa, PZ;
    h(document, "click", Ya);

    function Za() {
        function a(c) {
            //return q[c] = (p || document).getElementsByClassName("spl-" + c)[0]
			return q[c] = (p || gradioApp()).getElementsByClassName("spl-" + c)[0]
        }
        if (!K) {
            KB = document.body;
			K = gradioApp().querySelector('.gradio-container');
            Ka = a("scene");
            La = a("header");
            Ma = a("footer");
            Na = a("title");
            ...
            M = [a("pane")];
            U("close", $a);
            KB[T = "requestFullscreen"] || KB[T = "msRequestFullscreen"] || KB[T = "webkitRequestFullscreen"] || KB[T = "mozRequestFullscreen"] || (T = "");
